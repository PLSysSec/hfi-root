...
gem5_run_cmd="${GEM5DIR}/build/X86/gem5.fast --outdir=${HFIROOT}/benchmarks/${bmk}_${MODE}_$(date +%b%d-%H%M) ${GEM5DIR}/configs/example/se.py --cpu-type=Skylake --caches -c ./benchmark_${MODE}"
