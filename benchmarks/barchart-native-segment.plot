...
plot \
     '< paste results_guardpage.out results_guardpage.out' using (100):xtic(1) title 'Stock' linecolor rgb '#ABDDA4' fill pattern 3, \
     '< paste results_guardpage.out results_segment.out' using (100*$4/$2):xtic(1) title 'Segue' linecolor rgb "#2B83BA" fill pattern 3
